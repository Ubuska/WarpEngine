...
bool TransformComponent::VInit(TiXmlElement* pData)
{
	...
	Vec3 yawPitchRoll = Vec3(100, 100, 100);
...
TiXmlElement* TransformComponent::VGenerateXml(void)
{
    ...
    TiXmlElement* pPosition = WE_NEW TiXmlElement("Position");
   ...
   // pBaseElement->LinkEndChild(pPosition);
    ...
    TiXmlElement* pDirection = WE_NEW TiXmlElement("YawPitchRoll");
